    ...
    <div className="min-h-screen bg-[#0d0d0e] text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-[#121214] border border-zinc-900 rounded-xl p-8 shadow-2xl">
        ...
        {company.status === "Approved" ? (
          ...
          <div className="mt-6 flex items-center justify-center gap-3 rounded-2xl border border-violet-500/50 bg-violet-500/[0.05] p-4 text-sm font-medium text-violet-400 backdrop-blur-md max-w-md mx-auto">
            {/* ছোট লোডিং স্পিনার (ভায়োলেট কালার) */}
            <svg
            ...
            <span>Please wait to get approval</span>
          </div>
        )}
      </div>
    </div>
