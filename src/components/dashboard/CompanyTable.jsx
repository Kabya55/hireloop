                  ...
                  >
                    ...
                    <Table.Cell className="py-4 align-middle">
                      <div className="flex items-center gap-3">
                        {/* ইমেজ কন্টেইনার */}
                        <div className="w-9 h-9 flex items-center justify-center bg-neutral-800 text-neutral-300 rounded font-semibold text-sm tracking-wider overflow-hidden">
                          {company.logo ? (
                            <img
                              src={company.logo}
                              ...
                              onError={(e) => {
                                // যদি ইমেজ লিংকে সমস্যা থাকে, তাহলে ইমেজটি হাইড করে ব্যাকআপ টেক্সট দেখাবে
                                e.target.style.display = "none";
                              }}
                            />
                          ) : (
                            // যদি কোম্পানির কোনো ইমেজ না থাকে, তবে আগের মতো initials দেখাবে
